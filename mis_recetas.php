...
/*     if (!isset($_SESSION['id'])) {
    ...
    <div class="container mt-5">
        <div class="f_inventario">
            <form id="form-guardar-receta" method="POST" enctype="multipart/form-data" class="p-4 border rounded shadow-sm bg-light">
                <h1 class="text-center mb-4">Subí tu Receta</h1>

                <div class="mb-3">
                    <label for="nombre_receta" class="form-label">Nombre de la Receta</label>
                    <input type="text" class="form-control" name="nombre_receta" id="nombre_receta" placeholder="Ingrese el nombre de la receta..." required>
                </div>

                <div class="mb-3">
                    <label for="descripcion" class="form-label">Descripción de la Receta</label>
                    <textarea class="form-control" name="descripcion" id="descripcion" rows="4" placeholder="Escribe una descripción de la receta..." required></textarea>
                </div>
