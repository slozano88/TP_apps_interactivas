...
<body>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card-header text-center"><strong>Formulario de Modificar Receta</strong></div>
            <div class="p-2">
                <form class="row" action="proceso_modificar.php?id=<?php echo $row['id_receta']; ?>" method="POST" enctype="multipart/form-data">

                    <div class="col-p2">
                        <label class="form-label"><strong>Foto de la receta</strong></label>
                        <br>
                        <input type="file" class="form-control" name="foto_receta" value="<?php echo $row['nombre_img']; ?>">
                    ...
                    <div class="col p-2">
                        ...
                        <input type="text" REQUIRED autocomplete="off" class="form-control" name="nombre_receta" value="<?php echo $row['nombre']; ?>">
                    </div>

                    <div class="col p-2">
                        <label class="form-label"><strong>Descripción</strong></label>
                        <textarea class="form-control" name="descripcion_receta" rows="4"><?php echo $row['descripcion']; ?></textarea>
                    </div>

                    <div class="d-grid gap-2 p-2">
                        <button type="submit" class="btn btn-primary" name="modificar_receta">Modificar Receta</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card-header text-center"><strong>Listado de Recetas</strong></div>
            <table class="table">
                <thead>
                    <tr>
                        <th>Nombre</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a class="btn btn-danger" href="eliminar.php?id_ingrediente=<?php echo $row['id_receta']; ?>">Eliminar</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
