...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2024 a las 00:48:13
...
INSERT INTO `recetas` (`id_receta`, `id_usuario`, `nombre`, `descripcion`, `nombre_img`) VALUES
(5, 34, 'sopa', '123', 'banner.png'),
(7, 34, 'aaaa', 'a222222', 'img1_banner.jpg'),
(8, 34, 'aaa', 'sss', 'img2_banner.jpg');
...
--
ALTER TABLE `ingredientes`
  MODIFY `id_ingrediente` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `recetas`
--
ALTER TABLE `recetas`
  MODIFY `id_receta` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
